...
export class FriendsAndDebt {
     ...
     * @return Success
     */
    addMembers(body: BoardAddMemberModel | undefined, cancelToken?: CancelToken): Promise<BoardModel> {
     ...
     * @return Success
     */
    addCards(body: BoardAddCardModel | undefined, cancelToken?: CancelToken): Promise<BoardModel> {
     ...
     * @return Success
     */
    get(id: number | undefined, cancelToken?: CancelToken): Promise<BoardModel> {
     ...
     * @return Success
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined, cancelToken?: CancelToken): Promise<BoardModelPagedResultDto> {
     ...
     * @return Success
     */
    create(body: CreateBoardModel | undefined, cancelToken?: CancelToken): Promise<BoardModel> {
     ...
     * @return Success
     */
    update(body: UpdateBoardModel | undefined, cancelToken?: CancelToken): Promise<BoardModel> {
     ...
     * @return Success
     */
    approve(id: number | undefined, cancelToken?: CancelToken): Promise<void> {
     ...
     * @return Success
     */
    get2(id: number | undefined, cancelToken?: CancelToken): Promise<FriendModel> {
     ...
     * @return Success
     */
    getAll2(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined, cancelToken?: CancelToken): Promise<FriendModelPagedResultDto> {
     ...
     * @return Success
     */
    create2(body: CreateFriendModel | undefined, cancelToken?: CancelToken): Promise<FriendModel> {
     ...
     * @return Success
     */
    update2(body: UpdateFriendModel | undefined, cancelToken?: CancelToken): Promise<FriendModel> {
     ...
     * @return Success
     */
    create3(body: CreateRoleDto | undefined, cancelToken?: CancelToken): Promise<RoleDto> {
     ...
     * @return Success
     */
    update3(body: RoleDto | undefined, cancelToken?: CancelToken): Promise<RoleDto> {
     ...
     * @return Success
     */
    get3(id: number | undefined, cancelToken?: CancelToken): Promise<RoleDto> {
     ...
     * @return Success
     */
    getAll3(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined, cancelToken?: CancelToken): Promise<RoleDtoPagedResultDto> {
     ...
     * @return Success
     */
    create4(body: CreateTenantDto | undefined, cancelToken?: CancelToken): Promise<TenantDto> {
     ...
     * @return Success
     */
    delete4(id: number | undefined, cancelToken?: CancelToken): Promise<void> {
     ...
     * @return Success
     */
    get4(id: number | undefined, cancelToken?: CancelToken): Promise<TenantDto> {
     ...
     * @return Success
     */
    getAll4(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined, cancelToken?: CancelToken): Promise<TenantDtoPagedResultDto> {
     ...
     * @return Success
     */
    update4(body: TenantDto | undefined, cancelToken?: CancelToken): Promise<TenantDto> {
     ...
     * @return Success
     */
    create5(body: CreateUserDto | undefined, cancelToken?: CancelToken): Promise<UserDto> {
     ...
     * @return Success
     */
    update5(body: UserDto | undefined, cancelToken?: CancelToken): Promise<UserDto> {
     ...
     * @return Success
     */
    delete5(id: number | undefined, cancelToken?: CancelToken): Promise<void> {
     ...
     * @return Success
     */
    get5(id: number | undefined, cancelToken?: CancelToken): Promise<UserDto> {
     ...
     * @return Success
     */
    getAll5(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined, cancelToken?: CancelToken): Promise<UserDtoPagedResultDto> {
